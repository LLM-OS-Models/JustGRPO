...
- 7/26 새벽 2–3시: Run 3 v2 종료 → 평가 → **1차 판정**
- 7/26 오전 9–10시: Run 2 v2 종료 → ckpt-200/300 평가 → **판정 확정, 단독 vs 믹싱 비교표**
- 7/26 낮 이후: 판정에 따라 수학 2런(+MDLM) 또는 MDLM 단독 진행
- 7/27: 최종 매트릭스 + HF 업로드 완료 목표
